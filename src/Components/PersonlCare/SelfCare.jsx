...
const SelftCare = () => {
    const data = [
        { img: "/mhup/bodywash.jpeg", title: "Cleansing", step: "1" },
        { img: "/mhup/toning.jpeg", title: "Toning", step: "2" },
        { img: "/mhup/cerva.jpeg", title: "Moisturizing", step: "3" },
        { img: "/mhup/sunscreen.jpeg", title: "Sun Protection", step: "4" },
    ];
