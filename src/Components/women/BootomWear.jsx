...
const BootomWear = () => {
  ...
  return (
    <div>
       <div className='lg:mx-20 sm:mx-10 mx-1 md:my-5 mb-10'>
  ...
  <button onClick={()=>navigate("/nightware/shorts")} className='hover:bg-red-900 hover:text-white text-lg rounded-xl border border-red-900 px-8 py-2 transition duration-300'>
    See more
  </button>
</div>
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-4'>
          {data.map((item, index) => (
              <div onClick={()=>navigate("/nightware/shorts")}  key={index} className='border cursor-pointer border-gray-300 p-4'>
