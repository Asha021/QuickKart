         ...
         <div onMouseLeave={()=>setOpen(false)}  className='grid grid-cols-2 px-10 gap-30 p-5 bg-gray-100' >
          <div>
           ...
           <ul className='cur text-gray-700 border-r pr-15 '> 
            ...
            <Link className='hover:underline' to="/western/wear/cloths">Western Wear</Link><br />
            <Link className='hover:underline' to="/shop/saree">Saree</Link><br />
            <Link className='hover:underline' to="/trendy/kurti/kurta-sets">Kurti</Link><br />
            <Link className='hover:underline' to="/trendy/dresses">Dresses</Link>
           </ul>
          </div>
          <div className=''>
